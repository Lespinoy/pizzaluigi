	...
	<form>
		<label> van prijs 
			<span>${fouten.van}</span> 
				<input name='van' value='${param.van }' autofocus type='number' min='0' required></label> <label> tot prijs 
			<span>${fouten.tot}</span>
				<input name='tot' value='${param.tot }' autofocus type='number' min='0' required></label> <input type='submit' value='zoeken'>
	</form>
